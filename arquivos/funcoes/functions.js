...
const banner = cfonts.render((`Grupo Oficial: https://tinyurl.com/2d5uvj24\nDesenvolvedor Oficial: @Pxz modsz - 558598188647`), {
font: 'console',
align: 'center',
gradient: ['red', 'magenta']
});

const banner2 = cfonts.render((`YOSUKE|6.5`), {
  font: 'block',
  align: "center",
  gradient: ['red', 'magenta']
});
...
const authorname = "YOSUKE"
const packname = "PXZ MODS"

const chyt = "558598188657@s.whatsapp.net";
const nit = "558592549207@s.whatsapp.net";
const supre = "558598188647@s.whatsapp.net";
...
module.exports = { getBuffer, fetchJson, fetchText, generateMessageID, getGroupAdmins, getMembros, getRandom, banner2, banner, temporizador, color, recognize, bgcolor, isFiltered, addFilter, chyt, getExtension, convertSticker, upload, nit, getpc, supre }
