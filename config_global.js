...
return `*Lista de proprietários do bot:* \n\n🏅 *Dono Oficial da Bot:* ${numerodono_ofc}\n\n🥇 ${dono1}\n\n-🥈 ${dono2}\n-🥉 ${dono3}\n-🎖 ${dono4}\n-🎖 ${dono5}\n-🎖 ${dono6}`
}

exports.speedYosuke = (tempo, sender, r, kyun, uptime, infoSystem) => {
...
exports.statusBot = (isAnticall, isAntiPv, isAntiImg, isAntiVid, isAntiAudio, isAntiSticker, isNsfw, Antidoc, isAntiCtt, Antiloc, isAntilinkgp, isAntiLinkHard, isAntifake, isAntiNotas, isAnticatalogo, isPalavrao, isAntiFlood, isWelkom, isWelkom2, isSimi, isSimi2, isAutofigu, isAutorepo, isModobn, isModoAluguel, isLevelingOn, prefix) => {
...
return `Olá, não estou aceitando mensagens no pv!! `
}
